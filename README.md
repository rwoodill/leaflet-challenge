# leaflet-challenge
 ...
 - provided index page: Starer_Code > index.html
 - coding in JavaScript: Starter_Code > static > js > logic.js
 - provided css: Starter_Code > static > css > style.css
 - sample images: Starer_Code > Images > (whole folder)
